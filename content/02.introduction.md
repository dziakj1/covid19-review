...
Genetic factors may also play a role in risk of respiratory failure for COVID-19, including possibly higher risk to individuals of blood group A and possibly lower risk to individuals of type O [@doi:10.1056/NEJMoa2020283].

Obesity also appears to be associated with higher risk of severe outcomes from SARS-CoV-2,[@doi:10.1016/j.metabol.2020.154262] although further research is needed regarding the exact mechanisms  [@doi:10.1016/j.medj.2020.06.00].  
...
Although lack of individual-level exposure data and the impossibility of randomization make it difficult to elucidate the exact causal mechanism, this finding would be consistent with other findings for all-cause mortality (e.g., [@doi:10.1073/pnas.1803222115]).

The effects of the pandemic have the potential to cause major damage in low- to middle-income countries, including significant disruption to health care systems [@doi:10.1126/science.abc0035][@doi:10.1016/S2214-109X(20)30264-3][@doi:10.1016/S2214-109X(20)30229-1][@doi:10.1016/S2214-109X(20)30123-].
